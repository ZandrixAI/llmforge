...
def setup_arg_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Cache the state of a prompt to be reused with llmforge.generate"
    )
    parser.add_argument(
        "--model",
        type=str,
...
if __name__ == "__main__":
    print(
        "Calling `python -m llmforge.cache_prompt...` directly is deprecated."
        " Use `llmforge.cache_prompt...` or `python -m llmforge cache_prompt ...` instead."
    )
    main()
