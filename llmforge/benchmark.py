...
from llmforge import batch_generate, load, stream_generate
from llmforge.generate import DEFAULT_MODEL
from llmforge.utils import pipeline_load, sharded_load
...
def main():
    ...
    prompts = torch.randint(0, vocab_size, (batch_size, prompt_tokens)).tolist()
    prompt = prompts[0]
